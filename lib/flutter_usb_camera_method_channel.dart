      ...
      switch (call.method) {
        case USBCameraEvent.onUsbCameraChanged:
          ...
          _streamController.sink
              .add(USBCameraEvent(call.method, count: call.arguments));
          break;
        case USBCameraEvent.onLogChanged:
          _streamController.sink
              .add(USBCameraEvent(call.method, logString: call.arguments));
          break;

        case USBCameraEvent.onCameraPreview:
          print(call.method);
          _streamController.sink
              .add(USBCameraEvent(call.method, logString: call.arguments));
          break;
